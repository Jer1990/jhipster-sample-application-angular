...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().title(DEFAULT_TITLE).isChecked(DEFAULT_IS_CHECKED).date(DEFAULT_DATE);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().title(UPDATED_TITLE).isChecked(UPDATED_IS_CHECKED).date(UPDATED_DATE);
        return task;
    }
    ...
    @Test
    @Transactional
    void checkIsCheckedIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
        task.setIsChecked(null);
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).isChecked(UPDATED_IS_CHECKED).date(UPDATED_DATE);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).isChecked(UPDATED_IS_CHECKED);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).isChecked(UPDATED_IS_CHECKED).date(UPDATED_DATE);
